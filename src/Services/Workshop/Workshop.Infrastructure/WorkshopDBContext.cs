...
using Workshop.Infrastructure.EntityConfigurations;
...
namespace Workshop.Infrastructure
{
    public class WorkshopDBContext : DbContext, IUnitOfWork
    {
        ...
        public DbSet<BodyWorkType> BodyWorkTypes { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new BodyWorkTypeEntityTypeConfiguration());
            ...
            modelBuilder.ApplyConfiguration(new GearBoxTypeEntityTypeConfiguration());
            modelBuilder.ApplyConfiguration(new TireTypeEntityTypeConfiguration());
